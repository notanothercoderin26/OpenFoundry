        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/open_foundry.auth.AuthService/Register",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("open_foundry.auth.AuthService", "Register"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn login(
            &mut self,
            request: impl tonic::IntoRequest<super::LoginRequest>,
        ) -> std::result::Result<tonic::Response<super::TokenPair>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/open_foundry.auth.AuthService/Login",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("open_foundry.auth.AuthService", "Login"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn refresh_token(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/open_foundry.auth.AuthService/RefreshToken",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("open_foundry.auth.AuthService", "RefreshToken"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_me(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/open_foundry.auth.AuthService/GetMe",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("open_foundry.auth.AuthService", "GetMe"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod auth_service_server {
    ...
    pub const SERVICE_NAME: &str = "open_foundry.auth.AuthService";
    impl<T> tonic::server::NamedService for AuthServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod rbac_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct RbacServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl RbacServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> RbacServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            RbacServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/open_foundry.auth.RbacService/ListRoles",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("open_foundry.auth.RbacService", "ListRoles"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/open_foundry.auth.RbacService/AssignRole",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("open_foundry.auth.RbacService", "AssignRole"));
            self.inner.unary(req, path, codec).await
        }
    }
}
/// Generated server implementations.
pub mod rbac_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RbacServiceServer.
    #[async_trait]
    pub trait RbacService: std::marker::Send + std::marker::Sync + 'static {
        async fn list_roles(
            &self,
    ...
    #[derive(Debug)]
    pub struct RbacServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RbacServiceServer<T>
    where
        T: RbacService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/open_foundry.auth.RbacService/ListRoles" => {
                    #[allow(non_camel_case_types)]
                    struct ListRolesSvc<T: RbacService>(pub Arc<T>);
                    impl<
                        T: RbacService,
                    ...
                    for ListRolesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RbacService>::list_roles(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/open_foundry.auth.RbacService/AssignRole" => {
                    #[allow(non_camel_case_types)]
                    struct AssignRoleSvc<T: RbacService>(pub Arc<T>);
                    impl<
                        T: RbacService,
                    ...
                    for AssignRoleSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RbacService>::assign_role(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for RbacServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "open_foundry.auth.RbacService";
    impl<T> tonic::server::NamedService for RbacServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
