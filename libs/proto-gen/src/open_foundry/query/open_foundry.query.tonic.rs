        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn execute_query(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/open_foundry.query.QueryService/ExecuteQuery",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("open_foundry.query.QueryService", "ExecuteQuery"),
                );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/open_foundry.query.QueryService/ExplainQuery",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("open_foundry.query.QueryService", "ExplainQuery"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn save_query(
            &mut self,
            request: impl tonic::IntoRequest<super::SaveQueryRequest>,
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/open_foundry.query.QueryService/SaveQuery",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("open_foundry.query.QueryService", "SaveQuery"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/open_foundry.query.QueryService/ListSavedQueries",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "open_foundry.query.QueryService",
                        "ListSavedQueries",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        pub async fn delete_saved_query(
            ...
            tonic::Response<super::DeleteSavedQueryResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/open_foundry.query.QueryService/DeleteSavedQuery",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod query_service_server {
    ...
    pub trait QueryService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn save_query(
            &self,
            request: tonic::Request<super::SaveQueryRequest>,
        ) -> std::result::Result<tonic::Response<super::SavedQuery>, tonic::Status>;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/open_foundry.query.QueryService/ExplainQuery" => {
                    #[allow(non_camel_case_types)]
                    struct ExplainQuerySvc<T: QueryService>(pub Arc<T>);
                    impl<
                        T: QueryService,
                    ...
                    for ExplainQuerySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as QueryService>::explain_query(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/open_foundry.query.QueryService/SaveQuery" => {
                    #[allow(non_camel_case_types)]
                    struct SaveQuerySvc<T: QueryService>(pub Arc<T>);
                    impl<
                        T: QueryService,
                    > tonic::server::UnaryService<super::SaveQueryRequest>
                    for SaveQuerySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as QueryService>::save_query(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/open_foundry.query.QueryService/ListSavedQueries" => {
                    #[allow(non_camel_case_types)]
                    struct ListSavedQueriesSvc<T: QueryService>(pub Arc<T>);
                    impl<
                        T: QueryService,
                    ...
                    for ListSavedQueriesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as QueryService>::list_saved_queries(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/open_foundry.query.QueryService/DeleteSavedQuery" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteSavedQuerySvc<T: QueryService>(pub Arc<T>);
                    impl<
                        T: QueryService,
                    > tonic::server::UnaryService<super::DeleteSavedQueryRequest>
                    for DeleteSavedQuerySvc<T> {
                        type Response = super::DeleteSavedQueryResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as QueryService>::delete_saved_query(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "open_foundry.query.QueryService";
