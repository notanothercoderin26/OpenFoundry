        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/open_foundry.common.HealthService/Check",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("open_foundry.common.HealthService", "Check"));
...
pub mod health_service_server {
    ...
    pub const SERVICE_NAME: &str = "open_foundry.common.HealthService";
