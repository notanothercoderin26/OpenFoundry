...
> [`infra/helm/infra/manifests/cassandra/cluster-dev.yaml`](../../infra/helm/infra/manifests/cassandra/cluster-dev.yaml).
...
[`infra/helm/infra/manifests/cassandra/servicemonitor.yaml`](../../infra/helm/infra/manifests/cassandra/servicemonitor.yaml):
