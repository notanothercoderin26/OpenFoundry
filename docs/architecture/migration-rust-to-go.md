...
| 3 | Identity & authz: identity-federation, authorization-policy, tenancy-organizations, audit-compliance | 🟡 in progress — `identity-federation-service` slice 1/8 ✅ (register/login/token in Postgres). Slices 2–8 pending. |
