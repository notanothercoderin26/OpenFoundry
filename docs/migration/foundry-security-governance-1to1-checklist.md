...
- [ ] `SG.1` Security overview and shared responsibility UX (`P0`, `todo`)
...
- [ ] `SG.2` Enrollment, organization, and space model (`P0`, `todo`)
...
- [ ] `SG.3` Authentication provider integrations (`P0`, `todo`)
...
- [ ] `SG.4` User administration (`P0`, `todo`)
