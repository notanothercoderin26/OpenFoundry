...
export const COMPASS_RESOURCE_TYPE_REGISTRY: CompassResourceTypeDefinition[] = [
  ...
  },
  {
    ...
    openWith: [{ id: 'notebook', label: 'Notebook', icon: 'notebook', urlTemplate: '/notebooks/{rid}' }],
  },
  {
    ...
    openWith: [
      { id: 'dashboard', label: 'Dashboard', icon: 'dashboard', urlTemplate: '/dashboards/{rid}' },
  ...
  },
  {
    ...
    openWith: [{ id: 'model', label: 'Model catalog', icon: 'model', urlTemplate: '/model-catalog?model={rid}' }],
  },
  {
    ...
    defaultIcon: 'vertex-analysis',
    supportedActions: COMMON_ACTIONS,
    openAppURLTemplate: '/vertex/analyses/{rid}',
    openWith: [{ id: 'vertex-analysis', label: 'Vertex', icon: 'vertex-analysis', urlTemplate: '/vertex/analyses/{rid}' }],
  },
  {
    id: 'FOUNDRY_WORKFLOW',
    type: 'workflow',
