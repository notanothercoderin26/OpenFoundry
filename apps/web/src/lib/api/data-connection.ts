...
export const FALLBACK_CONNECTOR_CATALOG: ConnectorCatalogEntry[] = [
  ...
  },
  {
    ...
    description: 'Stream parquet/csv/json objects directly from a GCS bucket.',
  ...
  },
  {
    ...
    description: 'ABFS-compatible source for Microsoft Fabric lakehouses.',
    capabilities: ['batch_sync', 'virtual_table', 'exploration', 'file_export'],
    workers: ['foundry'],
    available: true,
    family: 'Storage',
  ...
  },
  {
    type: 'salesforce',
    name: 'Salesforce',
    description: 'Pull SOQL queries from a Salesforce org with cursor pagination.',
  ...
  },
  {
    type: 'snowflake',
    name: 'Snowflake',
    description: 'Run statements via /api/v2/statements with keypair JWT or OAuth.',
  ...
  },
  {
    ...
    description: 'Execute jobs.query against a project using a service account or bearer token.',
    capabilities: ['virtual_table', 'batch_sync', 'table_export'],
    workers: ['foundry'],
    available: true,
    family: 'SaaS',
  ...
  },
  {
    type: 'kinesis',
    name: 'Amazon Kinesis',
    description: 'Stream records from a Kinesis Data Stream via DescribeStream + GetRecords.',
  ...
  },
  {
    ...
    description: 'Subscribe to MQTT topics on a broker via rumqttc to ingest IoT telemetry.',
    capabilities: ['streaming_sync'],
    workers: ['foundry'],
    available: true,
    family: 'Streaming',
