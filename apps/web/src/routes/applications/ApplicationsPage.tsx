...
const APPS: AppEntry[] = [
  ...
  { id: 'compute-modules', name: 'Compute Modules', description: 'Run containerized workloads queryable from apps and pipelines.', to: '/compute-modules', icon: 'code', category: 'developer-toolchain' },
