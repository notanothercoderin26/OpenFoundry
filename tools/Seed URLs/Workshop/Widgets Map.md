---
title: "Palantir"
source: "https://www.palantir.com/docs/foundry/workshop/widgets-map/"
...
![Screenshot](Widgets Map.screenshot.png)
...
[Use case development](/docs/foundry/app-building/overview/)[Workshop](/docs/foundry/workshop/overview/)[Visualization widgets](/docs/foundry/workshop/widgets-visualization/)[Map](/docs/foundry/workshop/widgets-map/)
...
![Four examples of maps with different layer configurations.](Widgets Map_assets/img_001.png)
...
![The 'Show base layer picker' toggle below the base map configuration.](Widgets Map_assets/img_002.png)
...
- **Enable shaped-based selection:** Enable a tool to select objects on the map that intersect a drawn shape. \
  \
  ![A button labeled Select intersecting.](Widgets Map_assets/img_003.png) \
  \
- **Enable geospatial object search:** Enable a tool to search the Ontology for objects that intersect a drawn shape. \
  \
  ![A button labeled Search within.](Widgets Map_assets/img_004.png) \
  \
- **Enable shape-based track tools:** Enable tools that allow users to search the Ontology for tracks that intersect a drawn shape and filter map breadcrumbs by that shape. \
  \
  ![A button labeled Track search.](Widgets Map_assets/img_005.png) ![A button labeled Filter breadcrumbs.](Widgets Map_assets/img_006.png) \
  \
- **Enable shape editing tools:** Enable a tool to modify a drawn shape. \
  \
  ![A button labeled Modify.](/docs/resources/foundry/workshop/map-shapes-toolbar-modify.png) \
  \
...
PREVIOUSVega Chart](/docs/foundry/workshop/widgets-vega-chart/)

[NEXTGantt Chart

→](/docs/foundry/workshop/widgets-gantt-chart/)
