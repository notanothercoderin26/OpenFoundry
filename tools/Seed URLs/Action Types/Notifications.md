...
![Screenshot](Notifications.screenshot.png)
...
[Ontology building](/docs/foundry/ontology/overview/)[Action types](/docs/foundry/action-types/overview/)[Side effects](/docs/foundry/action-types/side-effects-overview/)[Notifications](/docs/foundry/action-types/notifications/)
...
![Dropdown menu for Add new rule](Notifications_assets/img_001.png)
...
![Recipients Dropdown](Notifications_assets/img_002.png)
...
![Content Type Dropdown](Notifications_assets/img_003.png)
...
![Example notification Configuration Labelled](Notifications_assets/img_004.png)
...
![Function-rendered Content max-recipients warning](Notifications_assets/img_005.png)
...
![Strict redaction email content default](Notifications_assets/img_006.png)
...
PREVIOUSOverview](/docs/foundry/action-types/side-effects-overview/)

[NEXTSet up a notification

→](/docs/foundry/action-types/set-up-notification/)
