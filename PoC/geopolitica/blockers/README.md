...
> + bulk-load smoke deferred to PoC execution). Other blockers track
> the aviation set; only the per-vertical delta lives here.
...
For B01, B03, B04, B05, B06, B07 the aviation files apply unchanged —
no geopolitics-specific override is needed today. If the geopolitical
