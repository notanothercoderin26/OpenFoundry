...
> (B07) remain. Other blockers still track the aviation set; only
> the per-vertical delta lives here.
...
For B01, B03, B05, B06, B07 the aviation files apply unchanged — no
